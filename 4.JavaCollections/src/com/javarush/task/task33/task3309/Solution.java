...
public class Solution {
    ...
    public static String toXmlWithComment(Object obj, String tagName,
                                          String comment) {
        try {
    ...
    private static String addCommentToTag(String xml, String tagName,
    ...
    private static void addCdataBlocks(Document document, Node rootElement) {
        if (rootElement.hasChildNodes()) {
            ...
            if (containsEscapeSymbols(textContent)) {
                ...
                rootElement.getParentNode().appendChild(document.
    ...
    private static String convertObjectToXML(Object o) throws Exception {
        StringWriter writer = new StringWriter();
        Marshaller marshaller = JAXBContext.newInstance(o.getClass()).
                createMarshaller();
